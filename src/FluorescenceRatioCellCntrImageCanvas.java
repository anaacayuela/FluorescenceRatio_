 ...
 * @author Kurt De Vos
 */
public class FluorescenceRatioCellCntrImageCanvas extends ImageCanvas {
	...
	public FluorescenceRatioCellCntrImageCanvas(ImagePlus img, Vector typeVector,
			FlurorescenceRatio cc, Overlay overlay) {
		super(img);
		this.img = img;
	...
	public void mousePressed(MouseEvent e) {
		...
		if (!delmode) {
			FluorescenceRatioCellCntrMarker m = new FluorescenceRatioCellCntrMarker(x, y, img.getCurrentSlice());
			currentMarkerVector.addMarker(m);
		} else {
			FluorescenceRatioCellCntrMarker m = currentMarkerVector.getMarkerFromPosition(
	...
	public void paint(Graphics g) {
		...
		while (it.hasNext()) {
			FluorescenceRatioCellCntrMarkerVector mv = (FluorescenceRatioCellCntrMarkerVector) it.next();
	...
	public void measure() {
		try {
			...
			IJ.write(" ");
			IJ.write("Circle Radius\t" +" "+ radius);
			IJ.write("Circle Area\t" +" "+ A);
